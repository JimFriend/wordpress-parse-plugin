...
class parseRestClient{
	...
	public function __construct(){
		...
		$this->_appid = $parseConfig::PARSE_APP_ID;
    	$this->_masterkey = $parseConfig::PARSE_MASTER_KEY;
    	$this->_restkey = $parseConfig::PARSE_API_KEY;
    	$this->_parseurl = $parseConfig::PARSE_API_URL;
